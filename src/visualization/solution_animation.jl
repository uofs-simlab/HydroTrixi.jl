...
function initialize_animation_plot_1d(x, y, mesh_vertices_x, t;
                                      exact_solution,
                                      numerical_label,
                                      exact_label,
                                      xlabel,
...
function update_animation_plot_1d!(animation_plot, x, y, mesh_vertices_x, t;
                                   exact_solution)
...
function HydroTrixi.animate_solution_1d(sol;
    ...
    record(animation_plot.fig, output_path, indices; framerate = framerate,
        ...
        update_animation_plot_1d!(animation_plot,
                                  x_frame,
                                  y_frame,
                                  mesh_vertices_x_frame,
                                  sol.t[i];
                                  exact_solution = exact_solution)
    end
