...
result_prefix = "richards_celia_1990_mixed_amr_interval30_maxlevel6_t" *
...
Trixi.trixi_include(joinpath(@__DIR__, "elixir_richards_celia_1990_amr.jl");
                    final_time = final_time, run_simulation = false, saveat = saveat,
                    amr_interval = 30, max_level = 6, save_analysis = true,
...
animate_solution_1d(ode; callback = callbacks, dt = dt, adaptive = adaptive,
                    reltol = reltol, abstol = abstol, saveat = saveat, component = 2,
...
println("Saved Celia AMR mass-bias plot to: $(mass_bias_output_path)")
println("Saved Celia AMR analysis data to: $(analysis_path)")
